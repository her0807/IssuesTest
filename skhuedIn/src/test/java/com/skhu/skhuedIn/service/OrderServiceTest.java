...
import com.skhu.skhuedIn.domain.Address;
import com.skhu.skhuedIn.domain.Member;
import com.skhu.skhuedIn.domain.Order;
...
import com.skhu.skhuedIn.repository.OrderRepository;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("상품주문시 상품 종류 수가 같아야  ", 1, getOrder.getOrderItems().size());
